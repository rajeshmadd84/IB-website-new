...
const nodes: FCNode[] = [
  ...
  { id: "ai", label: "Agentic AI", sub: "analyse · coordinate · recommend", x: 775, y: 60, w: 190, kind: "agent" },
...
const faqs = [
  { q: "Is this a BIM digital twin?", a: "No. IntelliByld does not try to recreate the building as a 3D or BIM digital twin. It connects the operational material records around procurement, suppliers, orders, deliveries and embodied carbon." },
  { q: "How does IntelliByld work with BIM?", a: "BIM can provide design intent, specifications and quantities. IntelliByld then connects those material requirements to procurement, supplier, delivery and carbon data. BIM remains the design environment; IntelliByld focuses on the material supply chain." },
  ...
  return (
    <main>
      ...
      <section className="ib-phero"><div className="ib-grid-bg" /><div className="ib-wrap" style={{ position: "relative" }}>
        ...
        <p>IntelliByld connects material requirements, suppliers, RFQs, purchase orders, shipments, delivery records, EPDs and carbon data without positioning itself as another BIM or 3D digital-twin platform.</p>
      </div></section>
      ...
      <section className="ib-sec"><div className="ib-wrap"><div className="ib-head ib-reveal">
        ...
        <h2>BIM tells you what to build. <span style={{ color: "var(--ib-cyan)" }}>IntelliByld follows the materials.</span></h2>
        <p>BIM and project systems remain where they are. IntelliByld connects the operational supply-chain information between design requirements, procurement activity, suppliers and site delivery.</p>
      ...
      <section className="ib-cta"><div className="ib-cta-bg" /><div className="ib-wrap ib-cta-inner ib-reveal"><h2>Connect one <span className="cy">material workflow</span></h2><p>Start with the BOQs, procurement records and supplier information you already use on a Singapore project.</p><div className="ib-cta-actions"><a href="/pilot" className="ib-btn ib-btn-primary">Start a Pilot <span className="arw">→</span></a><a href="/agentic-ai" className="ib-btn ib-btn-ghost">See Agentic AI</a></div></div></section>
    </main>
  );
}
