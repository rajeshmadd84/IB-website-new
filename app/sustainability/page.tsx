...
const faqs = [
  { q: "How does IntelliByld calculate embodied carbon?", a: "IntelliByld links material quantities to product-specific EPDs or approved emission factors. The calculation can evolve from design or BOQ quantities to awarded, procured and delivered quantities as better project data becomes available." },
  { q: "Is this direct measurement of CO₂ emissions?", a: "No. Embodied carbon is calculated from material quantities and appropriate emissions data such as EPDs or approved factors. IntelliByld's advantage is keeping those calculations connected to the procurement and delivery records that represent what the project is actually buying and building." },
  { q: "Can it compare suppliers on carbon before award?", a: "Yes. Where comparable EPD or emissions data is available, IntelliByld can surface carbon alongside price, lead time and supplier risk to support procurement decisions before award." },
  { q: "Is this intended to replace an LCA tool?", a: "Not necessarily. IntelliByld is focused on the construction material supply chain and on making procurement and delivery data usable for embodied-carbon intelligence. It can complement broader LCA, certification and reporting workflows." },
];
